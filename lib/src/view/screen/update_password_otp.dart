...
class UpdatePasswordOtp extends StatefulWidget {
  final email;
  const UpdatePasswordOtp({super.key, required this.email});
  static const String routeName = '/UpdatePasswordOtp';

  @override
  State<UpdatePasswordOtp> createState() => _OtpScreenState();
}

class _OtpScreenState extends State<UpdatePasswordOtp> {
  ...
  void VerifyUser() {
    authService.verifyUser(
      ...
      email: widget.email,
      otp:
          '${_node1Controller.text}${_node2Controller.text}${_node3Controller.text}${_node4Controller.text}${_node5Controller.text}${_node6Controller.text}',
    );
  }
